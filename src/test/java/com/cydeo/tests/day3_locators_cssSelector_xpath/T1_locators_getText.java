...
public class T1_locators_getText {
    ...
    public static void main(String[] args) {
       ...
       // driver.manage().window().maximize();
        ...
        //windows : alt + ent --> shortcut for  WebElement nputPssword
        ...
        String actualERRORmESSAGE = errorMessage.getText(); //  getText() --> return String

        if (expectedErrorMessage.equals(actualERRORmESSAGE)) {
            System.out.println("Error message is passed");
        } else {
